        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "Daily essentials", "Groceries" }
                });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "Name", "Price", "Sku", "StockQuantity" },
                values: new object[,]
                {
                    { 1, 1, "Laptop", 1200.00m, "ELEC-001", 10 },
                    { 2, 1, "Smartphone", 800.00m, "ELEC-002", 20 },
                    { 3, 2, "Rice (5kg)", 15.00m, "GROC-001", 50 }
                });
